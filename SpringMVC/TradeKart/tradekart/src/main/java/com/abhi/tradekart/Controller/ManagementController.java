...
import com.abhi.tradekart.Utilities.FileUtil;
import com.abhi.tradekart.Validator.ProductValidator;
...
public class ManagementController {
	...
	public ModelAndView exportDetails() {
		...
		ModelAndView mv = new ModelAndView("ProductListExcel");

		List<Product> productList = productDAO.list();
		mv.addObject("productlList", productList);
		return mv;
		// mv.addObject("title","Product Display");
		// List<Product> productList = productDAO.list();
