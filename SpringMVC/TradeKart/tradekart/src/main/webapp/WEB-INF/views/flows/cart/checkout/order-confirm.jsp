...
<title>TradeKart - Membership</title>
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="${contextRoot}/home">Continue
						Trading at TradeKart</a>
				</div>
			</div>
		</nav>
	...
	<div class="content">
		<div class="container">
			<div class="alert alert-success">
				...
				<h5 class="text-center">Products ordered will be shipped in
					three business days</h5>
			</div>
			<div class="row">
				<div class="col-xs-12">
			...
			<div class="text-center">
				<a href="${contextRoot}/show/all/products"
					class="btn btn-lg btn-warning">Continue Trading</a>
			</div>
		</div>
	</div>
