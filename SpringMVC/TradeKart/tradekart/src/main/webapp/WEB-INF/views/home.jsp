		...
		<div class="col-md-9">
				...
				<div class="col-md-12">
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<img class="slide-image" src="${images}/banner66.png" alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banner3.jpg" alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banner6.jpg" alt="">
							</div>
						</div>
			...
			<div class="row is-table-row">
				...
				<div class="col-sm-4 col-lg-4 col-md-4">
					<h4>Lookout for more Products</h4>
					<hr />
					<a class="btn btn-primary" href="${contextRoot}/show/all/products">Find
						Trades</a>
				</div>
