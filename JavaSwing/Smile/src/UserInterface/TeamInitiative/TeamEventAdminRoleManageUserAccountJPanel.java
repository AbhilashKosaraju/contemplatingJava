 ...
 * @author Sudeep
 */
public class TeamEventAdminRoleManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public TeamEventAdminRoleManageUserAccountJPanel(JPanel userProcessContainer, UserAccount account, TeamInitiativeOrganization organization, Enterprise enterprise, EcoSystem business) {
    ...
    public void populateEmployeeComboBox(TeamInitiativeOrganization organization){
    ...
    private void populateRoleComboBox(TeamInitiativeOrganization e){
    ...
    public void popData(TeamInitiativeOrganization organization) {
